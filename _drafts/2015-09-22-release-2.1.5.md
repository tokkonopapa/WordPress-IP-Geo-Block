...
embeded token (i.e. [nonce][WP-Nonces]) in the requests to the admin area, 
plugin area and theme area.
...
If you submit a following link into your WordPress comment and click it, you 
will get "0" with status `200 OK`. (Replace "example.com" to your home.)
