...
### <span id="1">New feature: Extra IPs for white/black list</span> ###
...
#### <span id="1.1">Remarks in Validation Logs</span> ####
...
### <span id="2">New feature: Evolution of validation target settings</span> ###
...
### <span id="3">Privacy considerations about IP address</span> ###
...
### <span id="4">Bug fix: Text message on comment form</span> ###
...
### <span id="5">Protection Performance</span> ###
